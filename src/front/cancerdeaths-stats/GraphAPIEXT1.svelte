<script>
    ...
    async function getData() {
        ...
        if (res2.ok) {
            ...
            datos2 = data2.data.covid19Stats;
            console.log(datos2);            
                console.log("Entradas recibidas: " + datos2.length);                

                datos2.forEach((stat) => {
                        country.push(stat.province);
...
<main>
    ...
    <!---->
    <br />
    <p style="text-align:center ;">Grafica de muertes producidad por cancer y contagios por covid - Source: https://ourworldindata.org/cancer#deaths-from-cancer</p>
